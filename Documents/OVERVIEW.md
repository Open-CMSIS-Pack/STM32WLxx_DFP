...
The **STMicroelectronics STM32WL Series Device Family Pack (DFP)** is a [CMSIS-Pack](https://open-cmsis-pack.github.io/Open-CMSIS-Pack-Spec/main/html/index.html) that:
...
> **Note:**
>
> STM32WLxx_DFP 2.0.0 requires [Generator-bridge v0.9.13](https://github.com/Open-CMSIS-Pack/generator-bridge/releases/tag/v0.9.13) or higher.
